...
import {Box, Center, Drawer, DrawerBody, DrawerContent, DrawerOverlay, VStack} from "@chakra-ui/react";
        ...
        <Drawer isOpen={props.isOpen} onClose={props.onClose} size={'full'}>
            ...
            <DrawerContent bg={'transparent'} textAlign='center' fontFamily='lobster'>
                ...
                <DrawerBody fontSize={'2.5rem'}>
                    ...
                    <Box pos="absolute" top={0} left={0} w="100%" h="100%" bg={"primary.600"} opacity={0.95}
                         zIndex={-1}/>
                </DrawerBody>
